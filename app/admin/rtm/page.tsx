      ...
      <main className="mx-auto flex max-w-2xl flex-col gap-5 px-4 py-6">
        ...
        >
          ...
          <p className="mt-3 text-xs" style={{ color: "#5B6B62" }}>
            הסריקה חינמית ובלי הגבלה. לכל כתבה יש שתי אפשרויות:{" "}
            <b>&quot;בריף מהכתבה 📰&quot;</b> — סרטון שמגיב לחדשה עצמה, או{" "}
            <b>&quot;בריף בהשראה 💡&quot;</b> — סרטון חינוכי כללי על הנושא, בלי
            תלות בכתבה, שאפשר להעלות מתי שרוצים.
          </p>
        </section>
